...
static void layout_menu_clear_marks_cb(GtkAction *UNUSED(action), gpointer UNUSED(data))
{
	...
	generic_dialog_add_message(gd, GTK_STOCK_DIALOG_QUESTION, "Clear all marks?",
				...
				TRUE);
	generic_dialog_add_button(gd, "dialog-ok", "OK", layout_menu_clear_marks_ok_cb, TRUE);
	generic_dialog_add_button(gd, "help-browser", _("Help"),
...
static void layout_menu_write_rotate(GtkToggleAction *UNUSED(action), gpointer data, gboolean keep_date)
{
	...
	while (work)
		...
		if (!run_result)
			...
			generic_dialog_add_button(gd, "dialog-ok", "OK", nullptr, TRUE);
...
static void layout_menu_window_rename_cb(GtkWidget *UNUSED(widget), gpointer data)
{
	...
	rw->button_ok = generic_dialog_add_button(rw->gd, "dialog-ok", _("OK"), window_rename_ok_cb, TRUE);
...
static void layout_menu_window_delete_cb(GtkWidget *UNUSED(widget), gpointer data)
{
	...
	dw->button_ok = generic_dialog_add_button(dw->gd, "dialog-ok", _("OK"), window_delete_ok_cb, TRUE);
...
static GtkActionEntry menu_entries[] = {
  ...
  { "Copy",		"edit-copy",		N_("_Copy..."),				"<control>C",		N_("Copy..."),				CB(layout_menu_copy_cb) },
  ...
  { "PermanentDelete",	"edit-delete",	N_("Delete..."),			"<shift>Delete",N_("Delete..."),			CB(layout_menu_delete_cb) }, 
  ...
  { "CloseWindow",	"document-close",	N_("C_lose window"),			"<control>W",		N_("Close window"),			CB(layout_menu_close_cb) },
  { "Quit",		"application-exit", 	N_("_Quit"),				"<control>Q",		N_("Quit"),				CB(layout_menu_exit_cb) },
  { "FirstImage",	"go-top",	N_("_First Image"),			"Home",			N_("First Image"),			CB(layout_menu_image_first_cb) },
  { "PrevImage",	"go-up",	N_("_Previous Image"),			"BackSpace",		N_("Previous Image"),			CB(layout_menu_image_prev_cb) },
  { "PrevImageAlt1",	"go-up",	N_("_Previous Image"),			"Page_Up",		N_("Previous Image"),			CB(layout_menu_image_prev_cb) },
  { "PrevImageAlt2",	"go-up",	N_("_Previous Image"),			"KP_Page_Up",		N_("Previous Image"),			CB(layout_menu_image_prev_cb) },
  { "NextImage",	"go-down",	N_("_Next Image"),			"space",		N_("Next Image"),			CB(layout_menu_image_next_cb) },
  { "NextImageAlt1",	"go-down",	N_("_Next Image"),			"Page_Down",		N_("Next Image"),			CB(layout_menu_image_next_cb) },

  { "ImageForward",	"go-last",	N_("Image Forward"),	nullptr,	N_("Forward in image history"),	CB(layout_menu_image_forward_cb) },
  { "ImageBack",	"go-first",	N_("Image Back"),		nullptr,	N_("Back in image history"),		CB(layout_menu_image_back_cb) },

  { "FirstPage","media-skip-backward",	N_("_First Page"),		nullptr,	N_( "First Page of multi-page image"),	CB(layout_menu_page_first_cb) },
  { "LastPage",	"media-skip-forward",		N_("_Last Page"),		nullptr,	N_("Last Page of multi-page image"),	CB(layout_menu_page_last_cb) },
  { "NextPage",	"media-seek-forward",	N_("_Next Page"),		nullptr,	N_("Next Page of multi-page image"),	CB(layout_menu_page_next_cb) },
  { "PrevPage",	"media-seek-backward",		N_("_Previous Page"),	nullptr,	N_("Previous Page of multi-page image"),	CB(layout_menu_page_previous_cb) },


  { "NextImageAlt2",	"go-down",	N_("_Next Image"),			"KP_Page_Down",		N_("Next Image"),		CB(layout_menu_image_next_cb) },
  { "LastImage",	"go-bottom",	N_("_Last Image"),			"End",			N_("Last Image"),			CB(layout_menu_image_last_cb) },
  { "Back",		"go-previous",	N_("_Back"),			nullptr,	N_("Back in folder history"),		CB(layout_menu_back_cb) },
  { "Forward",	"go-next",	N_("_Forward"),		nullptr,	N_("Forward in folder history"),	CB(layout_menu_forward_cb) },
  { "Home",		"go-home",		N_("_Home"),			nullptr,	N_("Home"),				CB(layout_menu_home_cb) },
  { "Up",		"go-up",	N_("_Up"),				nullptr,	N_("Up one folder"),				CB(layout_menu_up_cb) },
  ...
  { "RenameWindow",	"document-edit",		N_("Rename window"),	nullptr,	N_("Rename window"),	CB(layout_menu_window_rename_cb) },
  { "DeleteWindow",	"edit-delete",		N_("Delete window"),	nullptr,	N_("Delete window"),	CB(layout_menu_window_delete_cb) },
  { "NewCollection",	GTK_STOCK_INDEX,	N_("_New collection"),			"C",			N_("New collection"),			CB(layout_menu_new_cb) },
  { "OpenCollection",	"document-open",		N_("_Open collection..."),		"O",			N_("Open collection..."),		CB(layout_menu_open_cb) },
  { "OpenRecent",	nullptr,			N_("Open recen_t"),			nullptr,			N_("Open recent collection"),			nullptr },
  { "Search",		"edit-find",		N_("_Search..."),			"F3",			N_("Search..."),			CB(layout_menu_search_cb) },
  { "FindDupes",	"edit-find",		N_("_Find duplicates..."),		"D",			N_("Find duplicates..."),		CB(layout_menu_dupes_cb) },
  { "PanView",	PIXBUF_INLINE_ICON_PANORAMA,	N_("Pa_n view"),			"<control>J",		N_("Pan view"),				CB(layout_menu_pan_cb) },
  { "Print",		"document-print",	N_("_Print..."),			"<shift>P",		N_("Print..."),				CB(layout_menu_print_cb) },
  { "NewFolder",	"folder",	N_("N_ew folder..."),			"<control>F",		N_("New folder..."),			CB(layout_menu_dir_cb) },
  ...
  { "Preferences",	"preferences-system",	N_("P_references..."),			"<control>O",		N_("Preferences..."),			CB(layout_menu_config_cb) },
  { "Plugins",		"preferences-system",	N_("Configure _Plugins..."),		nullptr,			N_("Configure Plugins..."),		CB(layout_menu_editors_cb) },
  { "LayoutConfig",	"preferences-system",	N_("_Configure this window..."),	nullptr,			N_("Configure this window..."),		CB(layout_menu_layout_config_cb) },
  ...
  { "SaveMetadata",	"document-save",		N_("_Save metadata"),			"<control>S",		N_("Save metadata"),			CB(layout_menu_metadata_write_cb) },
  { "KeywordAutocomplete",	nullptr,	N_("Keyword autocomplete"),		"<alt>K",		N_("Keyword Autocomplete"),			CB(layout_menu_keyword_autocomplete_cb) },
  { "ZoomInAlt1",	"zoom-in",	N_("Zoom _in"),				"KP_Add",		N_("Zoom in"),				CB(layout_menu_zoom_in_cb) },
  { "ZoomIn",		"zoom-in",	N_("Zoom _in"),				"equal",		N_("Zoom in"),				CB(layout_menu_zoom_in_cb) },
  { "ZoomOut",		"zoom-out",	N_("Zoom _out"),			"minus",		N_("Zoom out"),				CB(layout_menu_zoom_out_cb) },
  { "ZoomOutAlt1",	"zoom-out",	N_("Zoom _out"),			"KP_Subtract",		N_("Zoom out"),				CB(layout_menu_zoom_out_cb) },
  { "Zoom100",		"zoom-original",	N_("Zoom _1:1"),			"Z",			N_("Zoom 1:1"),				CB(layout_menu_zoom_1_1_cb) },
  { "Zoom100Alt1",	"zoom-original",	N_("Zoom _1:1"),			"KP_Divide",		N_("Zoom 1:1"),				CB(layout_menu_zoom_1_1_cb) },
  { "ZoomFitAlt1",	"zoom-fit-best",	N_("_Zoom to fit"),			"KP_Multiply",		N_("Zoom to fit"),			CB(layout_menu_zoom_fit_cb) },
  { "ZoomFit",		"zoom-fit-best",	N_("_Zoom to fit"),			"X",			N_("Zoom to fit"),			CB(layout_menu_zoom_fit_cb) },
  ...
  { "Zoom200",	        "text-x-generic",			N_("Zoom _2:1"),			nullptr,			N_("Zoom 2:1"),				CB(layout_menu_zoom_2_1_cb) },
  { "Zoom300",	        "text-x-generic",			N_("Zoom _3:1"),			nullptr,			N_("Zoom 3:1"),				CB(layout_menu_zoom_3_1_cb) },
  { "Zoom400",		"text-x-generic",			N_("Zoom _4:1"),			nullptr,			N_("Zoom 4:1"),				CB(layout_menu_zoom_4_1_cb) },
  { "Zoom50",		"text-x-generic",			N_("Zoom 1:2"),				nullptr,			N_("Zoom 1:2"),				CB(layout_menu_zoom_1_2_cb) },
  { "Zoom33",		"text-x-generic",			N_("Zoom 1:3"),				nullptr,			N_("Zoom 1:3"),				CB(layout_menu_zoom_1_3_cb) },
  { "Zoom25",		"text-x-generic",			N_("Zoom 1:4"),				nullptr,			N_("Zoom 1:4"),				CB(layout_menu_zoom_1_4_cb) },
  { "ConnectZoomIn",	"zoom-in",	N_("Zoom _in"),				"plus",			N_("Connected Zoom in"),		CB(layout_menu_connect_zoom_in_cb) },
  { "ConnectZoomInAlt1","zoom-in",	N_("Zoom _in"),				"<shift>KP_Add",	N_("Connected Zoom in"),		CB(layout_menu_connect_zoom_in_cb) },
  { "ConnectZoomOut",	"zoom-out",	N_("Zoom _out"),			"underscore",		N_("Connected Zoom out"),		CB(layout_menu_connect_zoom_out_cb) },
  { "ConnectZoomOutAlt1","zoom-out",	N_("Zoom _out"),			"<shift>KP_Subtract",	N_("Connected Zoom out"),		CB(layout_menu_connect_zoom_out_cb) },
  { "ConnectZoom100",	"zoom-original",	N_("Zoom _1:1"),			"<shift>Z",		N_("Connected Zoom 1:1"),		CB(layout_menu_connect_zoom_1_1_cb) },
  { "ConnectZoom100Alt1","zoom-original",	N_("Zoom _1:1"),			"<shift>KP_Divide",	N_("Connected Zoom 1:1"),		CB(layout_menu_connect_zoom_1_1_cb) },
  { "ConnectZoomFit",	"zoom-fit-best",	N_("_Zoom to fit"),			"<shift>X",		N_("Connected Zoom to fit"),		CB(layout_menu_connect_zoom_fit_cb) },
  { "ConnectZoomFitAlt1","zoom-fit-best",	N_("_Zoom to fit"),			"<shift>KP_Multiply",	N_("Connected Zoom to fit"),		CB(layout_menu_connect_zoom_fit_cb) },
  ...
  { "OpenArchive",	"document-open",			N_("Open archive"),		nullptr,		N_("Open archive"),		CB(layout_menu_open_archive_cb) },
  { "FullScreen",	"view-fullscreen",	N_("F_ull screen"),			"F",			N_("Full screen"),			CB(layout_menu_fullscreen_cb) },
  { "FullScreenAlt1",	"view-fullscreen",	N_("F_ull screen"),			"V",			N_("Full screen"),			CB(layout_menu_fullscreen_cb) },
  { "FullScreenAlt2",	"view-fullscreen",	N_("F_ull screen"),			"F11",			N_("Full screen"),			CB(layout_menu_fullscreen_cb) },
  { "Escape",		"view-restore",N_("_Leave full screen"),		"Escape",		N_("Leave full screen"),		CB(layout_menu_escape_cb) },
  { "EscapeAlt1",	"view-restore",N_("_Leave full screen"),		"Q",			N_("Leave full screen"),		CB(layout_menu_escape_cb) },
  ...
  { "SlideShowPause",	"media-playback-pause",	N_("_Pause slideshow"), 		"P",			N_("Pause slideshow"), 			CB(layout_menu_slideshow_pause_cb) },
  { "SlideShowFaster",	"text-x-generic",	N_("Faster"), 		"<control>equal",			N_("Slideshow Faster"), 			CB(layout_menu_slideshow_faster_cb) },
  { "SlideShowSlower",	"text-x-generic",	N_("Slower"), 		"<control>minus",			N_("Slideshow Slower"), 			CB(layout_menu_slideshow_slower_cb) },
  { "Refresh",		"view-refresh",	N_("_Refresh"),				"R",			N_("Refresh"),				CB(layout_menu_refresh_cb) },
  { "HelpContents",	"help-browser",		N_("_Help manual"),			"F1",			N_("Help manual"),				CB(layout_menu_help_cb) },
  ...
  { "SearchAndRunCommand",	"edit-find",		N_("Search and Run command"),	"slash",	N_("Search commands by keyword and run them"),	CB(layout_menu_search_and_run_cb) },
  { "About",		"help-about",	N_("_About"),				nullptr,			N_("About"),				CB(layout_menu_about_cb) },
...
static GtkToggleActionEntry menu_toggle_entries[] = {
  ...
  { "ShowInfoPixel",	"color-picker",	N_("Pi_xel Info"),			nullptr,			N_("Show Pixel Info"),			CB(layout_menu_info_pixel_cb),	 FALSE  },
  { "IgnoreAlpha", "format-text-strikethrough",           N_("Hide _alpha"),          "<shift>A",     N_("Hide alpha channel"),       CB(layout_menu_alter_ignore_alpha_cb), FALSE},
  ...
  { "SlideShow",	"media-playback-start",	N_("Toggle _slideshow"),		"S",			N_("Toggle slideshow"),			CB(layout_menu_slideshow_cb),	 FALSE  },
  { "UseColorProfiles",	"color-management",	N_("Use _color profiles"), 		nullptr,			N_("Use color profiles"), 		CB(layout_color_menu_enable_cb), FALSE},
  ...
  { "ExifRotate",	"object-rotate-left",			N_("_Exif rotate"),  		"<alt>X",		N_("Toggle Exif rotate"),			CB(layout_menu_exif_rotate_cb), FALSE },
