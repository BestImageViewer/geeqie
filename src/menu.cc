...
void gsubmenu_add_edit(GMenu *menu, bool sensitive, GList *fd_list, GCallback func, gpointer data)
{
	EditorsList editors_list = editor_list_get();
...
GtkWidget *submenu_add_collections_new(GMenu *menu, bool sensitive,
...
void gsubmenu_add_collections(GMenu *menu, bool sensitive, GCallback func, gpointer data)
{
	GList *collection_list = nullptr;
...
static void widget_move_cb(GSimpleAction *action, GVariant *parameter, gpointer data)
{
